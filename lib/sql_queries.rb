...
"SELECT users.name, SUM(pledges.Amount) AS pledge_total FROM users JOIN pledges ON users.id = pledges.user_id GROUP BY users.name ORDER BY SUM(pledges.Amount) ASC;"
end
